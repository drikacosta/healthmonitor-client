...
fun RecoverPasswordScreen(onRecoverSuccess: () -> Unit, onBackClick: () -> Unit) {
    Column(modifier = Modifier.fillMaxSize().padding(16.dp), verticalArrangement = Arrangement.Center) {
        ...
        OutlinedTextField(value = code, onValueChange = { code = it }, label = { Text("Código de 4 dígitos") })

        Spacer(Modifier.height(16.dp))
        Button(onClick = onRecoverSuccess, modifier = Modifier.fillMaxWidth()) { Text("Enviar") }
